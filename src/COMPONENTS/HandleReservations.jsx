        ...
        <div>
            <div>
                <div class="sidebar">
                    <ul>
                        <h2>La Serve</h2>
                        <li><a onClick={HandleReservationsClick} id="active" className="item" href="#">Handle Reservations</a></li>
                        <li><a onClick={ManageEquipmentClick} className="item" href="#">Manage Equipment</a></li>
                        <li><a onClick={StatisticsClick} className="item" href="#">Statistics</a></li>
